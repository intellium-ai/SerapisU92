    ...
    if st.session_state.logged_in:
        with st.sidebar:
            ...
            if mode == "Use Existing Data":
                ...
                st.text("Energetic materials are generated by using the approach outlined")
                st.text("in the following paper:")
                st.text("https://pubs.acs.org/doi/pdf/10.1021/acs.jcim.2c00997.")
